...
import com.example.member.model.event.EventResult;
...
public class MemberEventProducer {
    ...
    public void occurEvent(EventResult result) throws JsonProcessingException {
        ListenableFuture<SendResult<String, EventResult>> future = (ListenableFuture<SendResult<String, EventResult>>) this.kafkaTemplate.send(TOPIC, result);
