...
public class RentalKafkaProducer implements EventOutputPort {
    ...
    public void occurRentalEvent(ItemRented itemRented) throws JsonProcessingException {
        ListenableFuture<SendResult<String, ItemRented>> future = (ListenableFuture<SendResult<String, ItemRented>>) kafkaTemplate1.send(TOPIC_RENT, itemRented);
    ...
    public void occurReturnEvent(ItemReturned itemReturned) throws JsonProcessingException {
        ListenableFuture<SendResult<String, ItemReturned>> future = (ListenableFuture<SendResult<String, ItemReturned>>) this.kafkaTemplate2.send(TOPIC_RETURN, itemReturned);
    ...
    public void occurOverdueClearedEvent(OverdueCleared overdueCleared) throws JsonProcessingException {
        ListenableFuture<SendResult<String, OverdueCleared>> future = (ListenableFuture<SendResult<String, OverdueCleared>>) this.kafkaTemplate3.send(TOPIC_CLEAR, overdueCleared);
    ...
    public void occurPointUseCommand(PointUseCommand pointUseCommand) {
        ListenableFuture<SendResult<String, PointUseCommand>> future = (ListenableFuture<SendResult<String, PointUseCommand>>) this.kafkaTemplate4.send(TOPIC_POINT, pointUseCommand);
